...
export default function AboutUsCompoonent() {
  return (
    <section className='flex flex-col items-center w-full h-full lg:p-24 p-2'>
        <motion.div className='lg:w-1/2 w-full flex flex-col justify-center items-center mb-10 shadow-md shadow-heading p-2'>
        ...
        <motion.div className='lg:w-1/2 w-full flex flex-col justify-center items-center mb-10 p-2'>
        ...
        <motion.div className='lg:w-1/2 w-full flex flex-col justify-center items-center mb-10 rounded-lg  shadow-md shadow-heading p-2'>
      ...
      <li>
        <strong>Customer Focus:</strong> Committing to understanding and meeting the unique needs of each client.
         ...
         <motion.div className='w-full flex flex-col justify-center items-center mb-10 p-2'>
